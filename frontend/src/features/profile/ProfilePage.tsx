    ...
    <div className="page-container max-w-3xl mx-auto">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between py-3 border-b border-navy-700">
            ...
            <button className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
              ...
              {user.mfa_enabled ? t('profile.mfa.manage') : t('profile.mfa.enable')}
            </button>
          </div>
      ...
      <div className="card border border-red-700/30">
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-white text-sm font-medium">{t('profile.delete.title')}</p>
            <p className="text-navy-400 text-xs">{t('profile.delete.desc')}</p>
          </div>
