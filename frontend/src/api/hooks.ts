...
const MOCK_LESSONS: Lesson[] = [
  { id: 'l1', course_id: 'c1', title: 'Algebraic Expressions', description: 'Introduction to variables, terms, and simplifying expressions.', order: 1, content_type: 'text', content_data: { body: 'An algebraic expression is a mathematical phrase that can contain ordinary numbers, variables (like x or y), and operators (like add, subtract, multiply, and divide). For example: 3x + 2y - 5. In this lesson, we will learn how to identify variables, constants, coefficients, and how to simplify expressions by combining like terms.' }, video_url: '', is_published: true, created_at: '2026-08-21T00:00:00Z', updated_at: '2026-08-21T00:00:00Z' },
  { id: 'l2', course_id: 'c1', title: 'Linear Equations', description: 'Solving one-step and two-step linear equations.', order: 2, content_type: 'text', content_data: { body: 'A linear equation is an equation of the form ax + b = c, where a, b, and c are constants. To solve a linear equation, we isolate the variable on one side. One-step equations: x + 5 = 12, so x = 7. Two-step equations: 2x + 3 = 11, so 2x = 8, so x = 4.' }, video_url: '', is_published: true, created_at: '2026-08-21T00:00:00Z', updated_at: '2026-08-21T00:00:00Z' },
  { id: 'l3', course_id: 'c1', title: 'Coordinate Geometry', description: 'Plotting points, lines, and finding gradients.', order: 3, content_type: 'text', content_data: { body: 'The coordinate plane has two axes: the x-axis (horizontal) and the y-axis (vertical). A point is written as (x, y). To plot a point, move x units along the x-axis and y units along the y-axis. The gradient (slope) of a line through two points (x1,y1) and (x2,y2) is: m = (y2 - y1) / (x2 - x1).' }, video_url: '', is_published: true, created_at: '2026-08-21T00:00:00Z', updated_at: '2026-08-21T00:00:00Z' },
  { id: 'l4', course_id: 'c1', title: 'Inequalities', description: 'Understanding and solving inequalities on the number line.', order: 4, content_type: 'text', content_data: { body: 'An inequality compares two expressions using <, >, <=, or >=. To solve inequalities, follow the same steps as equations, but flip the inequality sign when multiplying or dividing by a negative number. For example: -2x > 6, so x < -3.' }, video_url: '', is_published: true, created_at: '2026-08-21T00:00:00Z', updated_at: '2026-08-21T00:00:00Z' },
]
